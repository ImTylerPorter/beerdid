class RegistrationsController < Devise::RegistrationsController
  ...
  def sign_up_params
    params.require(:admin).permit(:email, :user_name, :password, :password_confirmation, :first_name, :last_name, :image)
  end

  def account_update_params
    params.require(:admin).permit(:email, :user_name, :password, :password_confirmation, :current_password, :first_name, :last_name, :image)
  end
