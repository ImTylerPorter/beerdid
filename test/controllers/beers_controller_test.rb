...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { abv: @beer.abv, brewery: @beer.brewery, description: @beer.description, ibu: @beer.ibu, location: @beer.location, name: @beer.name, style: @beer.style }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { abv: @beer.abv, brewery: @beer.brewery, description: @beer.description, ibu: @beer.ibu, location: @beer.location, name: @beer.name, style: @beer.style }
    assert_redirected_to beer_path(assigns(:beer))
  end
